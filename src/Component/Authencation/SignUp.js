...
const SignUp = () => {
  ...
  const onSubmit = async (data) => {
    ...
    setIsLoading(true);
    await axios
      .post("http://localhost:5000/public/api/register", {
        ...data,
      })
  ...
  return (
    <>
      <div className="min-h-screen">
        <h1 className="text-3xl font-bold text-red-500 text-center mt-5 mb-5">
          Welcome to Faucets.
        </h1>
            ...
            <div className="card-body">
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="form-control w-full ">
                  ...
                  />
                  {errors["phone"] && (
                    <p className="error-message label-text-alt text-red-500">
                      Invalid Phone
                    </p>
                  )}
                </div>
                    ...
                    <input
                      ...
                      {...register("password", {
                        ...
                        minLength: {
                          value: 6,
                          message:
                            "Minimum 6 characters and at least one upper letter, lower letter, one digit, one spacial character needed",
                        },
                        pattern: {
                          value:
                            /^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{6,}$/,
                          message:
                            "at least one upper letter, lower letter, one digit, one spacial character needed",
                        },
                      })}
                    />
