...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    ...
    setIsLoading(true);
    await axios
      .post("http://localhost:5000/public/api/login", {
        ...data,
      })
  ...
  return (
    <>
      <div className="h-screen">
        <h1 className="text-3xl font-bold text-red-500 text-center mt-20 mb-10">
          welcome to Faucets
        </h1>
          ...
          <div className="card w-96 bg-base-200 shadow-xl p-5 rounded-none">
            <div className="card-body">
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <input
                  className="btn w-full max-w-xs text-white rounded-none"
                  type="submit"
                  value="Login"
                />
              </form>
