...
const Wallet = ({ walletType }) => {
  ...
  const onSubmit = async (data) => {
    ...
    axios
      .post("http://localhost:5000/secure/api/create_wallet", {
        ...data,
      })
        ...
        <div className="p-4 bg-base-100">
          ...
          <div className="p-1 bg-slate-300 flex items-center">
            <svg
              ...
              height="16"
              fill="currentColor"
              className="bi bi-caret-down-fill inline-block mr-1"
              viewBox="0 0 16 16"
            >
            ...
            <p className="">
              ...
              <span className="font-bold"> {walletType} </span>, so you are
              requesting <span className="font-bold"> {walletType} </span>{" "}
              Link/ETH.
            </p>
          </div>
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="form-control w-full mt-2 max-w-1/2">
              ...
              <div className="">
                ...
                />
                <label className="label">
                  {errors.requestAmount?.type === "required" && (
                    <span className="label-text-alt text-red-500">
            ...
            ,
            <input
              className="btn w-full max-w-xs text-white rounded-none mt-4"
              type="submit"
              value="Send Request"
            />
          </form>
